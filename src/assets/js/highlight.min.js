...
!(function (e) {
  ...
  return (
    ...
    e.registerLanguage("coffeescript", function (e) {
      var t = {
          keyword:
            "in if for while finally new do return else break catch instanceof throw try this switch continue typeof delete // super yield import export from as default await then unless until loop of by when and or is isnt not",
